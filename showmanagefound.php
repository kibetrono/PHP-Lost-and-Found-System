...
while($row=mysqli_fetch_array($query)){
        ...
        echo"        <div class='card displaymanage'> ";

              echo    "

              <h1 class='text-center'>Item's Image</h1>
              <a href='#showDetailsmanage' >
              <img style='width:100%;height:50vh' src='assets/uploads/".$row['image']."' alt=''>
              </a>
              ";
                  echo"  <hr> ";
                  echo"   <h3>";
