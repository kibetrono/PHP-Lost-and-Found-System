...
<head>
  ...
  <title>Lost and Lost System</title>
...
?>
  ...
  <div class="content-wrapper whole">
    ...
    <section class="content">
     ...
     <h1 class="text-center">Claim your item</h1>
...
<div class="row">
  <div class="col-md-6">
    <label for="">Lost Location</label>
    <input type="text" name="location_lost" class="form-control" placeholder="Location Lost e.g Nairobi,Nakuru" required>
    <br>
...
<div class="row my-4">
  ...
  <div class="col-md-6">
    <input type="submit" name="postitem" class="form-control bg-secondary" style="width:100%" value="Claim Item">
  </div>
  <div class="col-md-3"></div>
