...
?>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
     <h2 class="text-center text-secondary" > Post Found  Item(s)</h2>
    </div>
    <!-- /.content-header -->

    <!-- Main content -->
    <section class="content">
      <form action="verifypost.php" method="POST" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="col-md-6">
            <label for="">Time Found</label>
            <input type="text" name="time_lost"  class="form-control" placeholder="Time found e.g 14:20" required>
          </div>
          <div class="col-md-6">
            <label for="">Date Found</label>
            <input type="date" name="date_lost" class="form-control" placeholder="Date found e.g 02/22/2022" required>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <input type="text" name="location_lost" class="form-control" placeholder="Location found e.g Nairobi,Nakuru" required>
            <br>
            <label for="">Found Item's Image</label>
            <input type="file" name="uploadfile" value="" class="form-control">
          </div>
          <div class="col-md-6">
            <label for="">Found Item's Description</label><br>
            <textarea name="item_description" id="" cols="60" rows="5" placeholder="Found item's description---" required></textarea>
          </div>
        </div>
        ...
        <div class="row my-4">
          ...
          <div class="col-md-6">
            <input type="submit" name="postitem" class="form-control bg-secondary" style="width:100%" value="Post Found Item">
          </div>
          <div class="col-md-3"></div>
