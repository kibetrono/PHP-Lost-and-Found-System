...
if($id ==1){
        ...
        echo"        <div class='card display'> ";
              ...
              echo    "
              <a href='#showDetails' >
              <img style='width:100%;max-height:180px' src='assets/uploads/".$row['image']."' alt=''>
              </a>
              ";
                  echo"  <hr> ";
                  echo"   <h3>";
                  ...
                  <div class='row'>
    <div class='col-md-5'>
    <a class='btn btn-success text-center' href='showmanagefound.php?show=$id'>Show Details</a>
    </div>
    <div class='col-md-3'></div>
    <div class='col-md-4'>
    <a class='btn btn-danger' href='deletefound.php?del=$id'>Delete</a>
  ...
  echo '<div class="alert alert-danger" >You are not allowed to visit this page!!! Only admins are the ones allowed</div>';
}
